...
const AuthForm = ({type}: {type: FormType}) => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    try {
        ...
        console.log(error);
        toast.error('Ooopsiee something went wrong: ${error}');
    }
  }
  ...
  return ( <div className="card-border lg:min-w-[566px]">
    <div className="flex flex-col gap-6 card py-14 px-10">
        <div className="flex flex-row gap-2 justify-center">
            ...
            <h2 className="text-primary-100"> RoadToSuccess</h2>
        </div> 
        <h3> Build your career roadmap with AI</h3>
        ...
        <p className="text-center">
            {isSignIn?'Start your Journey with us!!':'Have an account already?'}
